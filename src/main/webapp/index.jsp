<%-- 
    Document   : Index
    Created on : 3 jul. 2020, 12:24:35
...
<html>
    ...
    <body>
        ...
        <div class="box">
            ...
            <br>
            <br>
            <form action="/ma19010/ServletRecibir" method="post">
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        ...
                        <a href="mostrar.jsp"><input type="button" class="btn-primary" value="ver los usuarios ingresados"></a>
                    </div>
                </div>
            </form>
        </div>
